...
export async function getListings() {
  try {
    ...
    searchInput.addEventListener("input", () => {
      ...
      filterListings(results, searchTerm);
    });
    ...
    results.forEach(function (listing) {
      ...
      const currentCard = listingsContainer.lastElementChild;
...
function filterListings(results, searchTerm) {
  // listings based on the search
